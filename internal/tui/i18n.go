...
var zhStrings = map[string]string{
	...
	"auth_help2":      " [1] 编辑 prefix • [2] 编辑 proxy_url • [3] 编辑 priority • [4] 编辑 category • [5] 编辑分类优先级",
	"no_auth_files":   "  无认证文件",
...
var enStrings = map[string]string{
	...
	"auth_help2":      " [1] Edit prefix • [2] Edit proxy_url • [3] Edit priority • [4] Edit category • [5] Edit category priority",
